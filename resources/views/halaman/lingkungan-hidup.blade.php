...
@section('judul', 'Lingkungan Hidup - KVT Hub')
...
<section class="relative py-32 overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 text-center">
        ...
        <h1 class="text-5xl lg:text-6xl font-black text-white mb-6" data-aos="zoom-in">
            <span class="bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent">Lingkungan Hidup</span>
        </h1>
        <p class="text-lg text-gray-400 max-w-2xl mx-auto" data-aos="fade-up">
            Program ilmu lingkungan, konservasi, dan pengelolaan sumber daya alam.
        </p>
    </div>
</section>
...
<section class="py-20 relative">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl font-black text-white mb-4">Tentang Lingkungan Hidup</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">Program ilmu lingkungan, konservasi, dan pengelolaan sumber daya alam.</p>
        </div>
...
<section class="py-20 relative">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <div class="kaca rounded-3xl p-12" data-aos="zoom-in">
            <i class="fas fa-tree text-5xl text-emerald-400 mb-6"></i>
            <h2 class="text-3xl font-black text-white mb-4">Mulai Belajar Lingkungan Hidup</h2>
            <p class="text-gray-400 mb-8 max-w-lg mx-auto">Daftar sekarang dan mulai perjalanan Anda di bidang Lingkungan Hidup bersama KVT Hub.</p>
