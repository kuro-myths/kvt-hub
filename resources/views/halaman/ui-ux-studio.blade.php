...
@section('judul', 'UI/UX Studio - KVT Hub')

@section('konten')

{{-- HERO --}}
<section class="relative py-32 overflow-hidden">
    <div class="absolute inset-0 bg-gradient-to-br from-kvt-950 via-cyan-950/20 to-kvt-950"></div>
    <div class="absolute inset-0">
        <div class="absolute top-20 left-10 w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl animate-pulse-slow"></div>
        <div class="absolute bottom-20 right-10 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse-slow" style="animation-delay:2s"></div>
    </div>

    <div class="relative max-w-4xl mx-auto px-4 text-center">
        <div class="inline-flex items-center bg-cyan-500/10 border border-cyan-500/20 rounded-full px-4 py-1.5 mb-6" data-aos="fade-down">
            <i class="fas fa-pencil-ruler text-cyan-400 mr-2"></i>
            <span class="text-cyan-300 text-sm font-bold">KVT Hub Ekosistem</span>
        </div>
        <h1 class="text-5xl lg:text-6xl font-black text-white mb-6" data-aos="zoom-in">
            <span class="bg-gradient-to-r from-cyan-400 to-cyan-300 bg-clip-text text-transparent">UI/UX Studio</span>
        </h1>
        <p class="text-lg text-gray-400 max-w-2xl mx-auto" data-aos="fade-up">
            Studio desain UI/UX untuk produk digital yang user-friendly.
        </p>
    </div>
</section>
...
<section class="py-20 relative">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl font-black text-white mb-4">Tentang UI/UX Studio</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">Studio desain UI/UX untuk produk digital yang user-friendly.</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="kaca rounded-2xl p-8 text-center" data-aos="fade-up" data-aos-delay="300">
                <div class="w-16 h-16 rounded-2xl bg-cyan-500/10 flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-certificate text-cyan-400 text-2xl"></i>
                </div>
...
<section class="py-20 relative">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <div class="kaca rounded-3xl p-12" data-aos="zoom-in">
            <i class="fas fa-pencil-ruler text-5xl text-cyan-400 mb-6"></i>
            <h2 class="text-3xl font-black text-white mb-4">Mulai Belajar UI/UX Studio</h2>
            <p class="text-gray-400 mb-8 max-w-lg mx-auto">Daftar sekarang dan mulai perjalanan Anda di bidang UI/UX Studio bersama KVT Hub.</p>
