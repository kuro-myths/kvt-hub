...
<section class="relative py-32 overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 text-center">
        <div class="inline-flex items-center bg-yellow-500/10 border border-yellow-500/20 rounded-full px-4 py-1.5 mb-6" data-aos="fade-down">
            <i class="fas fa-search-dollar text-yellow-400 mr-2"></i>
        ...
        <h1 class="text-5xl lg:text-6xl font-black text-white mb-6" data-aos="zoom-in">
            <span class="bg-gradient-to-r from-yellow-400 to-yellow-300 bg-clip-text text-transparent">SEO & SEM</span>
        </h1>
        <p class="text-lg text-gray-400 max-w-2xl mx-auto" data-aos="fade-up">
            Kursus optimasi mesin pencari dan search engine marketing.
        </p>
    </div>
</section>
...
<section class="py-20 relative">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl font-black text-white mb-4">Tentang SEO & SEM</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">Kursus optimasi mesin pencari dan search engine marketing.</p>
        </div>
...
<section class="py-20 relative">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <div class="kaca rounded-3xl p-12" data-aos="zoom-in">
            <i class="fas fa-search-dollar text-5xl text-yellow-400 mb-6"></i>
            <h2 class="text-3xl font-black text-white mb-4">Mulai Belajar SEO & SEM</h2>
            <p class="text-gray-400 mb-8 max-w-lg mx-auto">Daftar sekarang dan mulai perjalanan Anda di bidang SEO & SEM bersama KVT Hub.</p>
