...
@section('judul', 'Teknik Informatika - KVT Hub')

@section('konten')

{{-- HERO --}}
<section class="relative py-32 overflow-hidden">
    <div class="absolute inset-0 bg-gradient-to-br from-kvt-950 via-blue-950/20 to-kvt-950"></div>
    ...
    <div class="relative max-w-4xl mx-auto px-4 text-center">
        <div class="inline-flex items-center bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6" data-aos="fade-down">
            <i class="fas fa-laptop-code text-blue-400 mr-2"></i>
            <span class="text-blue-300 text-sm font-bold">KVT Hub Ekosistem</span>
        </div>
        <h1 class="text-5xl lg:text-6xl font-black text-white mb-6" data-aos="zoom-in">
            <span class="bg-gradient-to-r from-blue-400 to-blue-300 bg-clip-text text-transparent">Teknik Informatika</span>
        </h1>
        <p class="text-lg text-gray-400 max-w-2xl mx-auto" data-aos="fade-up">
            Program teknik informatika, software engineering, dan sistem cerdas.
        </p>
    </div>
</section>
...
<section class="py-20 relative">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl font-black text-white mb-4">Tentang Teknik Informatika</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">Program teknik informatika, software engineering, dan sistem cerdas.</p>
        </div>
...
<section class="py-20 relative">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <div class="kaca rounded-3xl p-12" data-aos="zoom-in">
            <i class="fas fa-laptop-code text-5xl text-blue-400 mb-6"></i>
            <h2 class="text-3xl font-black text-white mb-4">Mulai Belajar Teknik Informatika</h2>
            <p class="text-gray-400 mb-8 max-w-lg mx-auto">Daftar sekarang dan mulai perjalanan Anda di bidang Teknik Informatika bersama KVT Hub.</p>
