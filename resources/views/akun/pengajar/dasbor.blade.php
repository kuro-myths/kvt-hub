...
@section('judul', 'Dasbor Pengajar - KVT Hub')
@section('judul-halaman', 'Dasbor Pengajar')
    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <span class="bg-green-500/20 text-green-400 text-xs px-3 py-1 rounded-full font-semibold">Pengajar</span>
                        @if($user->level)
                ...
                <a href="{{ route('pengajar.kelas.buat') }}" class="bg-gradient-to-r from-kvt-500 to-kvt-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-kvt-400 hover:to-kvt-500 transition shadow-lg">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            @php
                $kartuStat = [
                    ...
                    ['label' => 'Total Siswa', 'nilai' => $statistik['total_pengguna'], 'ikon' => 'fa-users', 'warna' => 'from-green-400 to-green-600'],
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-kvt-900/50 border border-kvt-700/30 rounded-2xl p-6" data-aos="fade-up">
                <h2 class="text-lg font-bold text-white mb-4"><i class="fas fa-chalkboard text-green-400 mr-2"></i>Kelas yang Diampu</h2>
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    @empty
                        <div class="col-span-2 text-center py-12">
                            ...
                            <a href="{{ route('pengajar.kelas.buat') }}" class="bg-kvt-500 hover:bg-kvt-600 text-white px-6 py-2 rounded-lg transition">Buat Kelas Pertama</a>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="bg-kvt-900/50 border border-kvt-700/30 rounded-2xl p-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="space-y-2">
                    <a href="{{ route('pengajar.kelas.buat') }}" class="flex items-center gap-3 p-3 rounded-xl bg-kvt-800/30 hover:bg-kvt-700/30 transition text-sm text-gray-300 hover:text-white">
                        <i class="fas fa-plus text-kvt-400 w-5"></i> Buat Kelas Baru
                    </a>
                    <a href="{{ route('pengajar.kelas.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-kvt-800/30 hover:bg-kvt-700/30 transition text-sm text-gray-300 hover:text-white">
                        <i class="fas fa-school text-green-400 w-5"></i> Kelola Kelas
                    </a>
