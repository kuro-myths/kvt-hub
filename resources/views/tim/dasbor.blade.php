    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <span class="bg-green-500/20 text-green-400 text-xs px-3 py-1 rounded-full font-semibold">Tim / Staff</span>
                    </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            @php
                $kartuStat = [
                    ...
                    ['label' => 'Total Pengguna', 'nilai' => $statistik['total_pengguna'], 'ikon' => 'fa-users', 'warna' => 'from-green-400 to-green-600'],
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    @forelse($kelasAktif as $kls)
                        <a href="{{ route('kelas.tampilkan', $kls) }}" class="block bg-kvt-800/30 hover:bg-kvt-800/50 rounded-xl p-5 transition border border-kvt-700/20 hover:border-kvt-500/30">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-kvt-400 text-sm"><i class="fas fa-users mr-1"></i>{{ $kls->anggota_count }} pengguna</span>
            ...
            <div class="bg-kvt-900/50 border border-kvt-700/30 rounded-2xl p-6" data-aos="fade-up" data-aos-delay="100">
                <h2 class="text-lg font-bold text-white mb-4"><i class="fas fa-bolt text-yellow-400 mr-2"></i>Menu Tim</h2>
                <div class="space-y-2">
                    <a href="{{ route('kelas.buat') }}" class="flex items-center gap-3 p-3 rounded-xl bg-kvt-800/30 hover:bg-kvt-700/30 transition text-sm text-gray-300 hover:text-white">
                    ...
                    <a href="{{ route('laporan.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-kvt-800/30 hover:bg-kvt-700/30 transition text-sm text-gray-300 hover:text-white">
                        <i class="fas fa-chart-line text-purple-400 w-5"></i> Lihat Laporan
                    </a>
                    <a href="{{ route('berita.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-kvt-800/30 hover:bg-kvt-700/30 transition text-sm text-gray-300 hover:text-white">
                        <i class="fas fa-newspaper text-blue-400 w-5"></i> Berita & Pengumuman
                    </a>
                </div>
            </div>
        </div>
